...
if __name__ == '__main__':
    ...
    #personas_eliminada = PersonaDAO.eliminar(persona1)
    #log.debug(f'Personas eliminadas: {personas_eliminada}')

    #Actualizar un registro
    #persona1 = Persona(1, 'Juan Jose', 'Pena', 'jjpena@mail.com')
    #personas_actualizadas = PersonaDAO.actualizar(persona1)
    #log.debug(f'Presonas actualizadas: {personas_actualizadas}')
