...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\LUNA\UTN-3erSemestre\Laboratorio 3\Python\Archivos\Leccion02\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\LUNA\UTN-3erSemestre\Laboratorio 3\Python\Archivos\Leccion02\venv\Scripts\deactivate.nu'
